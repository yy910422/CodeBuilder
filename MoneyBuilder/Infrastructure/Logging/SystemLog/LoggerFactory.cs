...
namespace MonBuilder.Logging
{
    ...
    public static class LoggerFactory
    {
        ...
        /// <summary>
        /// 依据LoggerName获取<see cref="MonBuilder.Logging.ILogger"/>
        /// </summary>
        /// <param name="loggerName">日志名称（例如：log4net的logger配置名称）</param>
        /// <returns><see cref="MonBuilder.Logging.ILogger"/></returns>
        ...
        /// <summary>
        /// 获取logger name为tunynet的 <see cref="MonBuilder.Logging.ILogger"/>
        /// </summary>
        /// <returns><see cref="MonBuilder.Logging.ILogger"/></returns>
